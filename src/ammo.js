...
async function AmmoPhysics() {
	...
	world.setGravity( new AmmoLib.btVector3( 0, - 9.81, 0 ) );
    ...
    function setAmmoImpulse( mesh, impulse, index = 0 ) {
        ...
        if ( mesh.isInstancedMesh ) {
            ...
            const impulseVec = new AmmoLib.btVector3(
            impulse.x,
            impulse.y,
            impulse.z
            );
    ...
    function getAmmoMesh(mesh, index = 0) {
        if ( mesh.isInstancedMesh ) {
			const bodies = meshMap.get( mesh );
			return bodies[ index ];
		} else if ( mesh.isMesh ) {
	...
	return {
        ...
        getAmmoMesh: getAmmoMesh,
        setAmmoImpulse:setAmmoImpulse,
